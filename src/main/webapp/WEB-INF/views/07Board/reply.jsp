...
<div class="container">
	...
	그리고 원본글을 가져오되 답변에 관련된 약간의 문자열을 추가해서 폼에
	입력한다. (제목=>[Re], 내용=>[원본글])	
	-->
	<form name="writeFrm" method="post" 
		...
		<!--  
		답변글 처리를 위해 원본글에 대한 idx값과 추가적으로 bgroup, bstep,
		bindent값이 필요하다. 해당 값을 통해 게시물을 하나의 그룹으로
		묶어주고, 그룹내에서 정렬 및 목록 출력시 들여쓰기 처리를 하게된다.
		-->
